...
parser.add_argument('-dim_emb', '--dim_embeddings', type=int, default=512)
...
def main():
        ...
        print(f'\n-  {backbone_name}\n')
        triplet_encoder = get_encoder(backbone_name=backbone_name, models_dir=models_dir, extracted_features=2208*3, dim_emb=args.dim_embeddings)
