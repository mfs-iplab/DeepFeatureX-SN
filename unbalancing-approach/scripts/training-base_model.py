...
parser = argparse.ArgumentParser(
    prog='training base model',
    description='train base model on a unbalanced dataset'
)
...
dset = umbalanced_dataset(dset_dir=datasets_path, main_class=args.main_class, guidance=guidance_path, for_overfitting=True, perc_to_take=0.04, transforms=trans)
